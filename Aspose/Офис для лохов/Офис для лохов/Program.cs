...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        //table.Head.Add("CustomerName");
        //table.Head.Add("Address");
        //table.Body.Add(new string[] { "Thomas Hardy", "120 Hanover Sq., London" });
        //table.Body.Add(new string[] { "Paolo Accorti", "Via Monte Bianco 34, Torino" });
        ...
        //    doc.MailMerge.Execute(table.Head.ToArray(), table.Body[i]);
        //    doc.Save($"Documents/MailMerge.ExecuteDataTable.WholeTable.{i}.docx");
